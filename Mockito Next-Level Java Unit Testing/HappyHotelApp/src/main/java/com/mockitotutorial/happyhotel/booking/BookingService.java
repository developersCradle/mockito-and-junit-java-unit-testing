...
public class BookingService {
	...
	private final PaymentService paymentService;//Takes care of money
	...
	public double calculatePrice(BookingRequest bookingRequest) {//calc room prize based on request
